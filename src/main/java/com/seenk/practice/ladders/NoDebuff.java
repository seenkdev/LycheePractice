...
public class NoDebuff extends MainLadders implements IKit {
    ...
    public String displayName() {
        return ChatColor.WHITE + "No-Debuff";
    }
    ...
    public ItemStack[] content() {
        ItemStack[] Contents = {new ItemBuilder(Material.DIAMOND_SWORD).addEnchant(Enchantment.DAMAGE_ALL, 2).addEnchant(Enchantment.DURABILITY, 3).addEnchant(Enchantment.FIRE_ASPECT, 1).toItemStack(),
